    ...
    if (issue) {
        ...
        return (
            <tr className="table__row">
                ...
                <td className="table__cell issue__createdby">{issue.createdby}</td>
                <td className="table__cell issue__updated">{updated}</td>
                <td className="table__cell issue__title">{issue.title}</td>
                <td className="table__cell issue__priority">{issue.priority}</td>
                <td className="table__cell issue__type">{issue.type}</td>
